...
Once the runtime starts, you can access the project at [http://localhost:8080/calculator](http://localhost:8080/calculator).
...
```
docker run -it --rm -p 8080:8080 calculator:v1
```
